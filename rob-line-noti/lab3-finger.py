...
#LINE TOKEN
LINE_NOTIFY_TOKEN = 'EtfFVkHZmh8ZJka6v1PYYUkXtgUfYXZs7igNJzpRYMF'

#Capture
vid = cv2.VideoCapture(0)

#Load Model
model = torch.hub.load('.', 'custom', path='finger03-best.pt', source='local', device='mps') 
